...
## Summary
- Total specific expectations: **39**
- Covered specific expectations: **10**
- Not yet covered specific expectations: **29**
- % of Specific Expectations Covered: **25.64%**
...
| --- | --- |
| A1.3 | develop computational artifacts for a variety of contexts and purposes that support the needs of diverse users and audiences 4 |
...
| B2.3 | assess the hardware and software requirements for various users, contexts, and purposes in order to make recommendations for devices and programs 5 |
