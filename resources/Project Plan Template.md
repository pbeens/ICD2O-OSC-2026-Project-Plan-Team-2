...
**Purpose/Rationale:**  
(Why this project? What authentic or disciplinary problem does it address?)
...
(Attach additional mapping page if needed.)
Linked compliance map: `references/expectations-compliance.md`
...
* Topic / format / audience / method (circle or specify)
...
* Report / Presentation / Prototype / Performance / Portfolio / Other:
...
* AGENTS.md
* README.md
* (Active project plan file in repo root)
* resources/Project Plan Template.md
* resources/ICD2O_2023.md
* resources/growSuccess.md
* resources/5E Lesson Plan Template.md
